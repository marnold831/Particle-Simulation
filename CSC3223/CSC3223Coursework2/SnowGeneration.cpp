/*	Author: Michael John Arnold
	Description: This class is repsonsible for creating a set number of particle within a set area. Particles a place randomly. Shaders, textures and positions are set 
	and uploaded to the GPU to be rendered.
*/
